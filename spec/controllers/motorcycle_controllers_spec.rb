...
RSpec.describe MotorcyclesController, type: :controller do
  ...
  let(:motorcycle) { Motorcycle.new(model: 'Sample Model', description: 'Sample Description', photo: Rack::Test::UploadedFile.new(Rails.root.join('spec', 'fixtures', 'test_photo.jpg'), 'image/jpeg'), duration: 5, finance_fee: 1000, purchase_fee: 2000, amount_payable: 5000, user: user) }
